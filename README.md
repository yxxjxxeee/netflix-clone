...
- TMDB API 연동 실시간 영화 목록 표시
- 영화 카드 클릭 시 YouTube 트레일러 재생
- 스크롤 시 Navbar 배경 전환 효과
- 영화 카드 가로 휠 스크롤

## 📚 Reference

- [Full Stack Netflix Clone using React JS & Firebase](https://youtu.be/YQQD67N5pi0?si=ycOqy4NMuCM2T_zM)
